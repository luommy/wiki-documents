---
description: 本指南介绍如何在 NVIDIA Jetson Orin 设备上安装与配置 n8n 自动化工作流工具。涵盖基于 Docker 的部署、持久化设置及远程访问配置，助力低代码自动化开发。
keywords: [n8n, NVIDIA Jetson, Orin Nano, 工作流自动化, Docker 部署, 低代码, 边缘 AI, 远程访问]
tags: [n8n, 自动化工作流, Jetson Orin, Docker, 边缘计算]
---
