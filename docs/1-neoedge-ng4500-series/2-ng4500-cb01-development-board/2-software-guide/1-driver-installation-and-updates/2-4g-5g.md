---
description: 介绍如何在 NeoEdge NG4500 系列设备上使用 4G/5G 模组（如移远 EM05 和 RM520N-GL）。涵盖驱动检测、minicom 串口工具交互、AT 指令调试及 Ubuntu 网络配置流程。
keywords: [4G 模组, 5G 模组, 移远通信, Quectel, AT 指令, minicom, 网络配置, Jetson Orin, 驱动安装, 边缘计算]
tags: [4G 模组, 5G 模组, 驱动安装, 网络配置, NG4500 系列]
---
