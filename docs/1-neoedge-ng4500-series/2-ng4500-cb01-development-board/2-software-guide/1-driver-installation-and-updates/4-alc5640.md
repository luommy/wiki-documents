---
description: 本指南介绍 Realtek ALC5640 音频编解码芯片在 NeoEdge NG4520 平台的驱动适配方法，涵盖 Audio 架构解析、设备树配置、内核编译及声卡测试步骤。
keywords: [ALC5640, 音频驱动, NG4500, Audio Codec, ASoC, 设备树, Jetson Orin, 音频配置]
tags: [音频驱动, 驱动开发, 硬件适配, NG4500 系列, 音频系统]
---
