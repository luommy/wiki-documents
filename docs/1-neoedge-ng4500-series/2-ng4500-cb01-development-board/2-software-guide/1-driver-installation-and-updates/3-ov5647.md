---
description: 本指南详细说明 OV5647 摄像头模组在 NeoEdge NG4520 平台的驱动适配流程，包括设备树配置、驱动编译、系统加载及 V4L2 调试验证。
keywords: [OV5647, 摄像头驱动, NG4500, 设备树, V4L2, CSI 摄像头, 驱动开发, Jetson Orin]
tags: [摄像头驱动, 驱动开发, 硬件适配, NG4500 系列, 图像采集]
---
