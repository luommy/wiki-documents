---
description: 本指南详细介绍 NeoEdge NG4500 系列（以 NG4520 为例）的开发环境搭建流程，涵盖源码部署、交叉编译工具链配置、内核与设备树编译及远程调试（SSH/RDP）方法。
keywords: [NG4500, 开发环境, 交叉编译, 内核编译, 设备树, 源码部署, 远程调试, SSH, RDP, Jetson Orin]
tags: [开发环境, 软件指南, 交叉编译, 远程调试, NG4500 系列]
---
