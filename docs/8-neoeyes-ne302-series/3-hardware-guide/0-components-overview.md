...
- 两板装配、USB-C、MicroSD、U6-UART 和 ST-LINK： [Hardware Connection](./1-hardware-connection.md)
- 构建与烧录命令： [Build, Flash and Update](../4-software-guide/1-build-and-flash.md)
- 源码中的原理图、PCB 图和工程文件： [NE302 source repository](https://github.com/camthink-ai/ne302)
