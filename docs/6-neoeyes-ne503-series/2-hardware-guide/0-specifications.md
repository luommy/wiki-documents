---
description: NE503 硬件规格参数详表，涵盖 Hailo15H SoC、LPDDR4、eMMC、QSPI Flash、图像传感器、IMU、以太网 PHY 等核心芯片的型号与电气参数，附硬件设计框图。
keywords: [NE503, 硬件规格, Hailo15H, IMX678, LPDDR4, LSM6DSR, 芯片参数, 硬件框图]
