...
| REST API | `http://<设备IP>:8080/api/v1/events/*` | 外部系统集成 |
| WebSocket | `ws://<设备IP>:8080/api/v1/events/stream` | Web 前端实时订阅 |
...
- [RESTful API 参考](../../4-application-guide/2-3rd-party-integration/0-restful-api.md) — 所有 HTTP 端点的完整参考
- [平台服务总览](../../3-software-guide/4-reference/0-platform-services.md) — Event Bus 等服务职责与源码指针
- [应用开发参考](../../4-application-guide/1-app-development/reference/1-app-reference.md) — 基于 SDK 开发自定义应用
