...
- [RESTful API Reference](../../4-application-guide/2-3rd-party-integration/0-restful-api.md) — Complete reference for all HTTP endpoints
- [Platform Services Overview](../../3-software-guide/4-reference/0-platform-services.md) — Responsibilities and source pointers for services such as the Event Bus
- [Application Development Reference](../../4-application-guide/1-app-development/reference/1-app-reference.md) — Building custom applications based on the SDK
