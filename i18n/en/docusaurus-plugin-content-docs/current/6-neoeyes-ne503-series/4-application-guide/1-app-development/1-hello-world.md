...
Don't want to build the image yourself? Download the prebuilt image [hello-world.tar](https://resources.camthink.ai/wiki/img/neoeyes-ne503-series/application-guide/app-development/hello-world/hello-world.tar) (this is the `image.tar`), pair it with the `app.yaml` from §2, and follow §4 to deploy to the device.
:::
