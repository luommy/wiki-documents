...
- **Video recording**: the current firmware does not store video locally; recording is done by an external NVR / VMS pulling the streams (see [Video and Imaging](../2-user-guide/1-media-and-image.md)).
