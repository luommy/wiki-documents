...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', justifyContent: 'center', alignItems: 'center' }}>
  <img src={useBaseUrl('https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/NE100-MB01_1.png')} alt="主板正面" style={{ height: '300px', objectFit: 'contain', margin: '0 auto' }} />
  <img src={useBaseUrl('https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/NE100-MB01_2.png')} alt="主板背面" style={{ height: '300px', objectFit: 'contain', margin: '0 auto' }} />
</div>
...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', justifyContent: 'center', alignItems: 'center' }}>
  <img src={useBaseUrl('https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/cat1PCBA.jpg')} alt="Cat-1 PCBA" style={{ height: '300px', objectFit: 'contain', margin: '0 auto' }} />
  <img src={useBaseUrl('https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/wifihalow.jpg')} alt="WiFi HaLow PCBA" style={{ height: '300px', objectFit: 'contain', margin: '0 auto' }} />
</div>
...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '20px', justifyContent: 'center', alignItems: 'center' }}>
  ...
  <img src={useBaseUrl('https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/ProductBL.png')} alt="NE101" style={{ height: '300px', objectFit: 'contain', margin: '0 auto' }} />
  <img src={useBaseUrl('https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/ProductR.png')} alt="NE101" style={{ height: '300px', objectFit: 'contain', margin: '0 auto' }} />
</div>
<table style={{ width: '100%', tableLayout: 'fixed' }}>
  <thead>
    <tr>
...
<AccessoriesTable
  accessories={[
    {
      image: "https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/Battery.png",
      name: "Battery",
      quantity: "4",
...
accessories={[
{
image: "https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/1.png",
name: "Desktop Bracket Extension",
quantity: "1",
description: ["Suitable for desktop and top mounting installations"]
},
{
image: "https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/3.png",
name: "Back Bracket Extension",
quantity: "1",
description: ["Suitable for wall mounting installation"]
},
{
image: "https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/5.png",
name: "Pole Bracket",
quantity: "1",
...
{
image: "https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/4.png",
name: "Dial Bracket",
quantity: "1",
description: ["Suitable for fixed installation of instrument image collection in a stable light condition."]
},
{
image: "https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/2.png",
name: "Meter Bracket",
quantity: "-",
...
{
image: "https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/sensor2.png",
...
{
image: "https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/sensor1.png",
...
{
image: "https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/wifihalow.png",
...
{
image: "https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/cat1PCBA.png",
...
image: useBaseUrl("https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/zw.jpg")
},
{
    ...
    const examples = [
      {
        ...
        image: useBaseUrl("https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/NE101_example_human_detect_1.png"),
      ...
      },
      {
        ...
        image: useBaseUrl("https://resources.camthink.ai/wiki/img/neoeyes-ne101-series/overview/lowpower.png"),
