---
description: Deploy n8n on NeoEdge NG4500 for powerful low-code workflow automation. Supports Docker installation and ARM64 architecture for seamless IoT integration.
keywords: [n8n, NeoEdge NG4500, Workflow Automation, Low-code, Docker Deployment, IoT Automation, ARM64, API Integration, Self-hosted Automation]
tags: [n8n, Workflow Automation, Low-code, Docker, IoT]
---
...
![overview](https://resources.camthink.ai/wiki/img/neoedge-ng4500-series/ng4500-cb01-development-board/software-guide/software-frameworks-and-tools/n8n/NG45XX_n8n_overview.png)
...
http://<Jetson-IP>:5678
```
![login](https://resources.camthink.ai/wiki/img/neoedge-ng4500-series/ng4500-cb01-development-board/software-guide/software-frameworks-and-tools/n8n/n8n_login.png)
